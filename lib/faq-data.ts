...
export const FAQ_GROUPS: FaqGroup[] = [
  {
    ...
    items: [
      ...
      },
      {
        ...
        a: "Please arrive 10 minutes early and wait outside. Doors lock once the session begins.",
      },
      {
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        a: "Only for Hot Mat Pilates.",
      },
      {
        q: "What if I have a medical condition?",
        a: "Please seek approval from your GP before attending.",
      },
      {
        q: "What if I'm pregnant or postnatal?",
        a: "Seek midwife approval and inform your instructor. Specialist pre/postnatal classes are coming soon.",
      },
      {
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        a: "Completely normal. Tell your instructor and they’ll guide you through every step.",
      },
      {
        q: "What happens in my first reformer class?",
        a: "Your instructor will walk you through the machine, guide each exercise and offer hands-on support.",
      },
    ],
  },
  {
    ...
    items: [
      {
        ...
        a: "Cancel at least 24 hours before class to receive your credit back. Late cancellations are charged.",
      },
      {
