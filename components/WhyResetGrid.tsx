...
export function WhyResetGrid() {
  ...
  return (
    <div className="mt-12 grid min-w-0 grid-cols-1 md:grid-cols-2 md:gap-x-12 lg:gap-x-16">
      <div className="min-w-0 pb-10 md:pb-12">
        <h3 className={itemTitleClass}>{ITEMS[0].t}</h3>
        <p className={itemBodyClass}>{ITEMS[0].d}</p>
      </div>
      <div className="min-w-0 border-t border-charcoal pb-10 pt-10 md:border-t-0 md:pb-12 md:pt-0">
      ...
      <div className="min-w-0 border-t border-charcoal pt-10 md:border-t-0 md:pt-12">
