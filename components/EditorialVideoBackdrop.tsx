...
export type EditorialVideoBackdropProps = {
  /**
   * `deep` — founding / pricing dark band overlays.
   * `mid` — softer overlays on `surface-editorial-dark` when a light PaperSheet sits on top.
   */
  variant?: "deep" | "mid";
...
/** Founding reformer loop + graded overlays; pauses when `prefers-reduced-motion: reduce`. */
